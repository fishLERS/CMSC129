            ...
            <div className="p-4 h-[565px] flex flex-col gap-1">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="form-control">
                    <label className="label py-1">
                      <span className="label-text text-xs text-black flex items-center gap-2">
                    ...
                    <input
                      type="time"
                      name="start"
                      className="input input-sm input-bordered w-full bg-white text-black [&::-webkit-calendar-picker-indicator]:invert [&::-webkit-calendar-picker-indicator]:opacity-100 focus:outline-none focus:ring-1 focus:ring-dark"
                      onChange={handleInput}
                ...
                <div className="form-control">
                  ...
                  <input
                    type="text"
                    name="adviser"
                    className="input input-sm input-bordered w-full bg-white rounded-lg text-black focus:outline-none focus:ring-1 focus:ring-dark"
